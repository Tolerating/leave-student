<template>
    <div class="qj_content">
        <mt-header class="qj_header" title="不留宿请假">
...
export default {
    ...
    methods: {
        ...
        subForm(){
            ...
            }else if(this.leaveReason !== "" && this.eTime !== "" && this.sTime !== ""){
               MessageBox.confirm("因"+ _self.leaveReason +"原因,需"+ 
                 ""+ _self.sTime +"至"+ _self.eTime +"请假"+ _self.getDayNum +"天","不留宿请假").then(function(action){
