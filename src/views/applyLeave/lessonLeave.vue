<template>
    <div class="qj_content">
        <mt-header class="qj_header" title="上课请假">
        ...
        <div style="padding:10px 10px 0px 10px">            
            ...
            <mt-field label="请假节数:" type="number" class="bottomBorder" placeholder="请输入请假节数" v-model.trim="lessonNum"></mt-field>
        ...
        subForm(){
            if(this.eTime < this.sTime){
                ...
                MessageBox.confirm("因"+ _self.leaveReason +"原因,需"+ 
                 ""+ _self.sTime +"至"+ _self.eTime +"请假"+ _self.getDayNum +"天,共"+_self.lessonNum+"节课","上课请假").then(function(action){
                    _self.$ajax.post(_self.baseUrl + "/StudentLeave/insertLeaveRecord",{           
                        ...
                        LeaveRecordSumLesson:_self.lessonNum,
